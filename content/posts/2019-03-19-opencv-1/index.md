...
2. 计算图像的强度梯度。为此，我们遵循类似于 *Sobel* 算子的方法：
   ...
   - 找到梯度强度和方向：
     ...
     $$
     \begin{array}{l} 
	 G = \sqrt{ G_{x}^{2} + G_{y}^{2} } \cr 
	 \theta = \arctan\left(\dfrac{ G_{y} }{ G_{x} }\right) 
	 \end{array}
     $$
...
结果如下：
{{< figure align=center src="https://s2.loli.net/2022/03/29/NpSw4mhEkfWqn1a.png" width="100%" caption="图 1 Canny 算子输出结果">}}
...
{{< figure align=center src="https://i.loli.net/2019/03/19/5c90cbc238932.jpg" width="100%" caption="图 2 Sobel 算子输出结果">}}
...
{{< figure align=center src="https://i.loli.net/2019/03/19/5c90d1506fb2a.jpg" width="100%" caption="图 3 Laplace 算子输出结果">}}
