...
$$
\begin{align*}
Av-\lambda v &= \overrightarrow{0} \cr
Av-\lambda I v &= \overrightarrow{0} \cr
(A - \lambda I)v &= \overrightarrow{0} \cr
...
$A$ 的主对角线上元素之和称为矩阵的**迹**（trace），记为 $\text{tr}(A)$，即
...
{{< figure align=center src="https://i.loli.net/2019/04/12/5cb04a00b76a7.jpg" width="50%" caption="图 1">}}

这是因为，矩阵 $M$ 与一个向量 $\begin{bmatrix} x & y \end{bmatrix}^T$ 相乘的结果为

$$
\begin{bmatrix}3 & 0 \cr 0 & 1\end{bmatrix} \begin{bmatrix}x \cr y\end{bmatrix}
= \begin{bmatrix}3x \cr y\end{bmatrix}
$$
...
{{< figure align=center src="https://i.loli.net/2019/04/12/5cb05c78103f3.jpg" width="50%" caption="图 2">}}
...
$$
\begin{bmatrix} * & * & * \cr   & * & * \cr   &   & * \end{bmatrix} \rightarrow
\begin{bmatrix}   &   & * \cr   & * & * \cr * & * & * \end{bmatrix} \rightarrow
...
$$
\begin{align*}
RQ &= (P\tilde{R}^TR)(P\tilde{Q}^T) = P\tilde{R}^T\tilde{Q}^T = P(\tilde{Q}\tilde{R})^T \cr
&= P(\tilde{A}^T)^T=P\tilde{A}=PPA=A
\end{align*}
$$
